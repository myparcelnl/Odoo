        ...
        if self.delivery_type == 'myparcel_dhl_fy':
            if wizard_id:
                if wizard_id.x_aa_mp_age_control and wizard_id.x_aa_mp_only_receiver:
                    raise ValidationError(_('Age Check and Receiver Only cannot be used together. Please choose one of them.'))
                if wizard_id.x_aa_mp_hide_sender and wizard_id.x_aa_mp_insurance:
                    raise ValidationError(_('Hide sender and Insurance cannot be used together. Please choose one of them.'))
            else:

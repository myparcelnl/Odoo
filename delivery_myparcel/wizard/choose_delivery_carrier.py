...
class ChooseDeliveryCarrier(models.TransientModel):
    ...
    def _get_delivery_rate(self):
        ...
        #                                  x_aa_mp_home_delivery=self.x_aa_mp_home_delivery,
        ...
        self_context = self.with_context(x_aa_mp_age_control=self.x_aa_mp_age_control,
                                         ...
                                         x_aa_mp_insurance_pricelist_id=self.x_aa_mp_insurance_pricelist_id,#.id if self.x_aa_mp_insurance_pricelist_id else False,

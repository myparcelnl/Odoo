...
from odoo.addons.delivery_myparcel_official.data.myparcel_static_data import MYPARCEL_CARRIER_CODES, MYPARCEL_DELIVERY_CODES, \
...
class MyParcelMixin(models.AbstractModel):
    ...
    def get_module_version(self):
        current_module = self.env['ir.module.module'].sudo().search([('name', '=', 'delivery_myparcel_official')],
                                                                    limit=1)
